...
const PaintingChampionship = () => {
  return (
    <section className="py-20 bg-gradient-to-b from-gray-100 to-yellow-100">
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16">
          ...
          <Button 
            className="bg-blue-400 hover:bg-blue-500 text-white px-8 py-4 text-lg rounded-full font-bold"
          >
            Ver Ranking
          </Button>
        </div>
        ...
        <div className="flex justify-center">
          <div className="w-32 h-40 bg-yellow-300 rounded-t-full rounded-b-3xl relative">
            <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 w-20 h-20 bg-yellow-300 rounded-full">
              <div className="absolute -top-2 left-3 w-6 h-6 bg-yellow-300 rounded-full"></div>
              <div className="absolute -top-2 right-3 w-6 h-6 bg-yellow-300 rounded-full"></div>
            ...
            <div className="absolute top-4 left-1/2 transform -translate-x-1/2 w-20 h-12 bg-orange-500 rounded-t-3xl"></div>
            <div className="absolute top-8 -left-3 w-6 h-12 bg-yellow-300 rounded-full"></div>
            <div className="absolute top-8 -right-3 w-6 h-12 bg-yellow-300 rounded-full"></div>
          </div>
        </div>
      </div>
    </section>
